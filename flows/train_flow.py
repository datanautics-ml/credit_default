...
def train_ml_models(dataset: pd.DataFrame, use_hyperparameter_optimization: bool = True) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        results = trainer.train_all_models(
            X_train, y_train, X_test, y_test, use_hyperparameter_optimization=use_hyperparameter_optimization
        )
...
def ml_training_flow(data_file: Optional[Path] = None, use_hyperparameter_optimization: bool = True) -> None:
    ...
    # Train models
    training_results = train_ml_models(dataset, use_hyperparameter_optimization=use_hyperparameter_optimization)
